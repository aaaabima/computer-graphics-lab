...
void translate2D(GLfloat tx, GLfloat ty)
{
  ...
  /* Concatenate matTrans with the composite matrix. */
...
void displayFcn()
{
  ...
  glColor3f(0.0, 0.0, 0.1); // Set initial fill color to blue.
  ...
  transformVerts2D(nVerts, verts); // First transformation: Scale.
